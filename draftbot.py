...
draftOrder = ["<@788631404740476940>", "<@742103529178660935>", "<@861479520670580747>", "<@702995687058571344>", "<@706233650772967515>", "<@720315865173852172>", "<@373237227976654860>", "<@483873900409782273>", "<@758711213554925626>", "<@689562617576161341>", "<@497201623924342819>", "<@705521037810466818>"]
rdo = draftOrder[::-1]
draft = []
for i in range(14):
    if i%2==0:
